/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 536c64dbaae6af4f304c7da0ff757315)
...
declare namespace Cloudflare {
	...
	type ExeoraAuditV2StreamRecord = { schema_version: number; id: string; user_id: string; project_id: string; worktree_id?: string; worktree_slug?: string; tool: string; status: string; duration_ms: number; error_code?: string; client_id?: string; client_name?: string; endpoint: string; created_at: string | number };
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LATEST_CLI_VERSION" | "CLOUDFLARE_ACCOUNT_ID" | "AUDIT_R2_BUCKET" | "AUDIT_R2_WAREHOUSE" | "AUDIT_R2_TABLE" | "AUDIT_R2_LEGACY_TABLE" | "AUDIT_SCHEMA_VERSION" | "AUDIT_WAREHOUSE_START_DAY" | "EXEORA_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_SECRET" | "REQUEST_STATE_SECRET">> {}
}
declare module "*.css" {
	const value: string;
