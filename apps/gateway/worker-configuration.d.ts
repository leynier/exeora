/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7cbbd9861e0537b5ff5366a19038b793)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXEORA_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_SECRET">> {}
}
declare module "*.css" {
	const value: string;
