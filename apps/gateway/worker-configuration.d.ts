/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7b66e6bfac4518885a219b935b6dde15)
...
interface __BaseEnv_Env {
	...
	RL_MCP: RateLimit;
	ASSETS: Fetcher;
	AUDIT_STREAM: import("cloudflare:pipelines").Pipeline<Cloudflare.ExeoraAuditStreamRecord>;
...
declare namespace Cloudflare {
	...
	type ExeoraAuditStreamRecord = { schema_version: number; id: string; user_id: string; project_id: string; tool: string; status: string; duration_ms: number; error_code?: string; client_id?: string; client_name?: string; endpoint: string; created_at: string | number };
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LATEST_CLI_VERSION" | "CLOUDFLARE_ACCOUNT_ID" | "AUDIT_R2_BUCKET" | "AUDIT_R2_WAREHOUSE" | "AUDIT_R2_TABLE" | "AUDIT_WAREHOUSE_START_DAY" | "AUDIT_WRITE_MODE" | "EXEORA_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_SECRET" | "REQUEST_STATE_SECRET">> {}
}
declare module "*.css" {
	const value: string;
