/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2fdebfe5061bc84c4aaf3b96b1cbac85)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LATEST_CLI_VERSION" | "EXEORA_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_SECRET" | "REQUEST_STATE_SECRET">> {}
}
declare module "*.css" {
	const value: string;
