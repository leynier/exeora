/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a46a53bc46ef27c6dc1e292773d69540)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LATEST_CLI_VERSION" | "CLOUDFLARE_ACCOUNT_ID" | "AUDIT_R2_BUCKET" | "AUDIT_R2_WAREHOUSE" | "AUDIT_R2_TABLE" | "AUDIT_WAREHOUSE_START_DAY" | "EXEORA_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_SECRET" | "REQUEST_STATE_SECRET">> {}
}
declare module "*.css" {
	const value: string;
