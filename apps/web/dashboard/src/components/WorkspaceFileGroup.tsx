    ...
    <section className="border-border-subtle border-b py-2">
      <header className="flex items-center justify-between gap-2 px-3 pb-1.5">
        ...
        {onActionAll && actionAllLabel && files.length > 0 ? (
          <button
            type="button"
            className="text-label-md text-foreground-faint hover:text-foreground rounded px-1.5 py-0.5"
            onClick={onActionAll}
          >
            {actionAllLabel}
          </button>
        ...
        files.map((file) => {
          ...
          return (
            ...
            >
              ...
              <button
                type="button"
                className="text-label-md text-foreground-faint hover:bg-surface-variant invisible shrink-0 rounded px-1.5 py-1 group-hover:visible group-focus-within:visible"
